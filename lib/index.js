...
module.exports = function(nb) {
  ...
  this.query = function(options, data, cb) {
    deprecate({since: '1.5.0', removed: '2.0.0', message: 'You should use rp.request() instead'});
  ...
  this.end = function() {
    deprecate({since: '1.5.0', removed: '2.0.0', message: 'You should use rp.exit() instead'});
    this.exit();
  }
